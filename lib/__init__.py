...
def _separate_batch(packet: Packet, report_slices):
...
class BNO08X:
    ...
    def __init__(self, reset=None, debug: bool = False) -> None:
    ...
    def _send_packet(self, channel: int, data: bytearray):  # noqa: PLR6301
        raise RuntimeError("Not implemented")

    def _read_packet(self):  # noqa: PLR6301
        raise RuntimeError("Not implemented")
